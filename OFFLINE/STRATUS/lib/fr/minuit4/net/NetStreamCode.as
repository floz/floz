...
package fr.minuit4.net 
{
	...
	public class NetStreamCode 
	{
		public static const CONNECTION_SUCCESS:String = "NetStream.Connect.Success";
		public static const CONNECTION_CLOSED:String = "NetStream.Connect.Closed";
