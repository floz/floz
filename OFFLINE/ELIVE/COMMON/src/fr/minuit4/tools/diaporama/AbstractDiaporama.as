...
package fr.minuit4.tools.diaporama 
{
	...
	public class AbstractDiaporama extends Sprite
	{
		 ...
		 */
		public function AbstractDiaporama( width:Number = -1, height:Number = -1 ) 
		{
		...
		{
			next();
			dispatchEvent( new Event( AbstractDiaporama.SWITCH_COMPLETE ) );
		}
