...
package com.bigarobas.utils.debug
{
     ...
     */
	public class HiResStats extends Sprite
	{	
		 ...
		 */
		public function HiResStats( theme : Object = null ) : void
		{
			if (theme)
			{
		...
		private function update(e : Event) : void
		{
			...
			if( _timer - 1000 > _ms_prev )
			{
				...
				_fps_graph = Math.min( 50, ( _fps / _stage.frameRate ) * 50 );
				...
				_xml.fps = "FPS: " + _fps + " / " + _stage.frameRate;
				_xml.mem = "MEM: " + _mem;
