...
package painting.brushes 
{
	...
	public class MultiLines extends Sprite implements IBrush
	{
		...
		public function MultiLines( linesCount:int, deltaX:Number = 0, deltaY:Number = 0, colors:Vector.<uint> = null ) 
		{
