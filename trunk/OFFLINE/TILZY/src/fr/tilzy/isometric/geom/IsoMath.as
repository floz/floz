 ...
 */
package fr.tilzy.isometric.geom 
{
	import fr.tilzy.core.geom.Point3D;
	import fr.tilzy.isometric.geom.transformations.IAxonometricTransformation;
	import fr.tilzy.isometric.geom.transformations.DimetricTransformation;
