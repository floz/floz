<?php
    ...
    function swfaddress() {
        ...
        $swfaddress_value = preg_replace('/^([^\?.]*[^\/])(\?|$)/', '$1/$2', $swfaddress_value, 1);
    
        $query_string = (strpos($swfaddress_value, '?')) ? substr($swfaddress_value, strpos($swfaddress_value, '?') + 1, strlen($swfaddress_value)) : '';
        $swfaddress_path = ($query_string != '') ? substr($swfaddress_value, 0, strpos($swfaddress_value, '?')) : $swfaddress_value;
        
        if (strpos($swfaddress_value, '?')) {
