...
package fr.minuit4.motion 
{
	...
	public class M4Tween_old 
	{
		...
		private static var _currentTween:M4Tween_old;
		private static var _firstTween:M4Tween_old;
		private static var _lastTween:M4Tween_old;
		
		private var _prev:M4Tween_old;
		private var _next:M4Tween_old;
		...
		private static function startEngine():void
		{
			...
			_tweensController.addEventListener( Event.ENTER_FRAME, M4Tween_old.render, false, 0, true );
			_engineStarted = true;
		}
		...
		{
			var tween:M4Tween_old = _firstTween;
		...
		public static function initialize( tweensCount:int = -1 ):void
		{
			...
			var tween:M4Tween_old = new M4Tween_old();
			_lastTween = tween;	
			...
			while ( --i > -1 )
			{
				...
				if( i > 0 ) tween = tween._prev = new M4Tween_old();
			}
		 ...
		 */
		public static function create( target:Object, duration:Number, params:Object ):M4Tween_old
		{
			if ( duration <= 0 )
				duration = 0.001;
			...
			if ( !_availableInPool )
			{
				...
				var oldLastTween:M4Tween_old = _lastTween;
				tween = new M4Tween_old();
				_lastTween = tween;
		 ...
		 */
		public static function release( tween:M4Tween_old ):void
		{
