...
package fr.minuit4.UIpv3d 
{
	...
	public class UIUnfolding extends DisplayObject3D
	{
		 ...
		 */
		public function UIUnfolding(pView:BasicView = null, pNbHPlanes:int = 6, pNbVPlanes:int = 5, pSizePlanes:int = 200, pTime:int = 4, pMaterial:MaterialObject3D = null) 
		{
			if (!pView) return;
			_view = pView;
		...
		private function launchUnfolding():void
		{
			...
			var mp:UIMovedPlane = new UIMovedPlane(_sizePlanes, _material);
